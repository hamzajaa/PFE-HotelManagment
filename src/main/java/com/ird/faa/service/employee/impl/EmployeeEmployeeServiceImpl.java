...
@Service
public class EmployeeEmployeeServiceImpl extends AbstractServiceImpl<Employee> implements EmployeeEmployeeService {
    ...
    @Autowired
    private CountryEmployeeService countryService;
    @Autowired
    private CityEmployeeService cityService;
    @Autowired
    private GradeEmployeeService gradeService;
