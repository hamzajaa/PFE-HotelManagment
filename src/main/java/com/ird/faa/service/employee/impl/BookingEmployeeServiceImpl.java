...
import com.ird.faa.service.employee.facade.BookingEmployeeService;
        import com.ird.faa.service.employee.facade.PaymentStatusEmployeeService;
        import com.ird.faa.service.employee.facade.PaymentEmployeeService;
        import com.ird.faa.service.employee.facade.GuestEmployeeService;
        import com.ird.faa.service.employee.facade.PriceManagerEmployeeService;
        import com.ird.faa.service.employee.facade.BookingStatusEmployeeService;
        import com.ird.faa.service.employee.facade.BookingItemRoomEmployeeService;
...
@Service
public class BookingEmployeeServiceImpl extends AbstractServiceImpl<Booking> implements BookingEmployeeService {
...
private BookingDao bookingDao;
    ...
    private ArchivableService<Booking> archivableService;
        @Autowired
        private PaymentStatusEmployeeService paymentStatusService ;
        @Autowired
        private PaymentEmployeeService paymentService ;
        @Autowired
        private GuestEmployeeService guestService ;
        @Autowired
        private PriceManagerEmployeeService priceManagerService ;
        @Autowired
        private BookingStatusEmployeeService bookingStatusService ;
        @Autowired
        private BookingItemRoomEmployeeService bookingItemRoomService ;
