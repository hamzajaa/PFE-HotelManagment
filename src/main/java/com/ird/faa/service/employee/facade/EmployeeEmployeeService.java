...
public interface EmployeeEmployeeService extends AbstractService<Employee,Long,EmployeeVo>{
...
/**
    ...
    */
    ...
    Employee archiver(Employee employee) ;
    Employee desarchiver(Employee employee);
