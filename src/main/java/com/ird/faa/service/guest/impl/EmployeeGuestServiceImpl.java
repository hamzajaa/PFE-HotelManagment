...
import com.ird.faa.service.guest.facade.*;
...
@Service
public class EmployeeGuestServiceImpl extends AbstractServiceImpl<Employee> implements EmployeeGuestService {
    ...
    @Autowired
    private DepartementGuestService departementService;
    @Autowired
    private CountryGuestService countryService;
    @Autowired
    private CityGuestService cityService;
    @Autowired
    private GradeGuestService gradeService;
