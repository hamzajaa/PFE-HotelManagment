...
import com.ird.faa.service.guest.facade.BookingGuestService;
        import com.ird.faa.service.guest.facade.PaymentStatusGuestService;
        import com.ird.faa.service.guest.facade.PaymentGuestService;
        ...
        import com.ird.faa.service.guest.facade.BookingStatusGuestService;
...
@Service
public class BookingGuestServiceImpl extends AbstractServiceImpl<Booking> implements BookingGuestService {
...
private BookingDao bookingDao;
    ...
    private ArchivableService<Booking> archivableService;
        @Autowired
        private PaymentStatusGuestService paymentStatusService ;
        @Autowired
        private PaymentGuestService paymentService ;
        @Autowired
        private GuestGuestService guestService ;
        @Autowired
        private PriceManagerGuestService priceManagerService ;
        @Autowired
        private BookingStatusGuestService bookingStatusService ;
        @Autowired
        private BookingItemRoomGuestService bookingItemRoomService ;
