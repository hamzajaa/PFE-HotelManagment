...
import com.ird.faa.service.guest.facade.HouseKeepingGuestService;
        ...
        import com.ird.faa.service.guest.facade.FloorGuestService;
...
@Service
public class HouseKeepingGuestServiceImpl extends AbstractServiceImpl<HouseKeeping> implements HouseKeepingGuestService {
...
private HouseKeepingDao houseKeepingDao;
    ...
    private ArchivableService<HouseKeeping> archivableService;
        ...
        @Autowired
        private RoomTypeGuestService roomTypeService ;
        @Autowired
        private FloorGuestService floorService ;
        @Autowired
