...
@Service
public class EmployeeChercheurServiceImpl extends AbstractServiceImpl<Employee> implements EmployeeChercheurService {
    ...
    @Autowired
    private CityChercheurService cityService;
    @Autowired
    ...
    public List<Employee> findAllNonArchive() {
        String query = "SELECT o FROM Employee o  WHERE o.archive != true AND o.visible = true";
        query += " ORDER BY o.dob";
        return entityManager.createQuery(query).getResultList();
    }

    public List<Employee> findAllByOwner() {
        List<Employee> result = new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())) {
            String query = "SELECT o FROM Employee o  WHERE o.archive != true AND o.visible = false AND o.username = '" + currentUser.getUsername() + "'";
            query += " ORDER BY o.dob";
