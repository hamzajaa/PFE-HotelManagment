...
@Service
public class PriceTypeChercheurServiceImpl extends AbstractServiceImpl<PriceType> implements PriceTypeChercheurService {
...
priceTypes.forEach(e->priceTypeDao.save(e));
        ...
        public List<PriceType> findAllNonArchive(){
        String query = "SELECT o FROM PriceType o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<PriceType> findAllByOwner(){
        List<PriceType> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM PriceType o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
