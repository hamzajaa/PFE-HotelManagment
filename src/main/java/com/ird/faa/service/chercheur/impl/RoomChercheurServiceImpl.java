...
@Service
public class RoomChercheurServiceImpl extends AbstractServiceImpl<Room> implements RoomChercheurService {
...
private RoomDao roomDao;
    ...
    private ArchivableService<Room> archivableService;
        ...
        @Autowired
        private HouseKeepingChercheurService houseKeepingService ;
...
rooms.forEach(e->roomDao.save(e));
        ...
        public List<Room> findAllNonArchive(){
        String query = "SELECT o FROM Room o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<Room> findAllByOwner(){
        List<Room> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM Room o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
