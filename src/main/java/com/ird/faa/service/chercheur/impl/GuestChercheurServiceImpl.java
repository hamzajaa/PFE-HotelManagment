...
import com.ird.faa.service.chercheur.facade.GuestChercheurService;
        import com.ird.faa.service.chercheur.facade.CountryChercheurService;
...
@Service
public class GuestChercheurServiceImpl extends AbstractServiceImpl<Guest> implements GuestChercheurService {
...
private GuestDao guestDao;
    ...
    private ArchivableService<Guest> archivableService;
        @Autowired
        private CountryChercheurService countryService ;
...
guests.forEach(e->guestDao.save(e));
        ...
        public List<Guest> findAllNonArchive(){
        String query = "SELECT o FROM Guest o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<Guest> findAllByOwner(){
        List<Guest> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM Guest o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
