...
@Service
public class ExpensesChercheurServiceImpl extends AbstractServiceImpl<Expenses> implements ExpensesChercheurService {

@Autowired
private ExpensesDao expensesDao;

        @Autowired
        private ExpensesCategoryChercheurService expensesCategoryService ;
