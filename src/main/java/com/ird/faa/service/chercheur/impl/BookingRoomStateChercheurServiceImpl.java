...
@Service
public class BookingRoomStateChercheurServiceImpl extends AbstractServiceImpl<BookingRoomState> implements BookingRoomStateChercheurService {
...
public List<BookingRoomState> findAll(){
    List<BookingRoomState> result= new ArrayList();
...
bookingRoomStates.forEach(e->bookingRoomStateDao.save(e));
        ...
        public List<BookingRoomState> findAllNonArchive(){
        String query = "SELECT o FROM BookingRoomState o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<BookingRoomState> findAllByOwner(){
        List<BookingRoomState> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM BookingRoomState o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
