...
@Service
public class HouseKeepingAdminServiceImpl extends AbstractServiceImpl<HouseKeeping> implements HouseKeepingAdminService {
    ...
    @Autowired
    private HouseKeepingStatutAdminService houseKeepingStatutService;
    @Autowired
