...
import com.ird.faa.service.admin.facade.HouseKeepingAdminService;
...
@Service
public class RoomAdminServiceImpl extends AbstractServiceImpl<Room> implements RoomAdminService {
    ...
    @Autowired
    private HouseKeepingAdminService houseKeepingService;
