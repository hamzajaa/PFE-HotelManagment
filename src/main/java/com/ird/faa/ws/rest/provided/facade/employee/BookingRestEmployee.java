...
public class BookingRestEmployee {
...
private BookingConverter bookingConverter;
    ...
    public List<BookingVo> findByCriteria(@RequestBody BookingVo bookingVo){
        ...
        return bookingService.deleteByPriceManagerId(id);
            ...
            @PutMapping("/archiver/")
            public BookingVo archiver(@RequestBody BookingVo bookingVo){
                Booking booking = bookingService.archiver(bookingConverter.toItem(bookingVo));
                return bookingConverter.toVo(booking);
                }

            @PutMapping("/desarchiver/")
            public BookingVo desarchiver(@RequestBody BookingVo bookingVo){
                Booking booking = bookingService.desarchiver(bookingConverter.toItem(bookingVo));
                return bookingConverter.toVo(booking);}
            }
