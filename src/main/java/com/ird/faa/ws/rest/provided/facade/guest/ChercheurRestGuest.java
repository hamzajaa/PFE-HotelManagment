...
import com.ird.faa.service.guest.facade.ChercheurGuestService;
...
@RestController
@RequestMapping("api/guest/chercheur")
public class ChercheurRestGuest {

@Autowired
private ChercheurGuestService chercheurService;
