...
public class RoomTypeVo {
    ...
    private List<RoomTypeItemAmenityVo> roomTypeItemAmenitysVo;
...
//    private List<AmenityVo> amenitysVo;
    ...
    public List<RoomTypeItemAmenityVo> getRoomTypeItemAmenitysVo() {
        return this.roomTypeItemAmenitysVo;
    }

    public void setRoomTypeItemAmenitysVo(List<RoomTypeItemAmenityVo> roomTypeItemAmenitysVo) {
        this.roomTypeItemAmenitysVo = roomTypeItemAmenitysVo;
    }
