...
@RestController
@RequestMapping("api/guest/roomType")
public class RoomTypeRestGuest {
...
private RoomTypeConverter roomTypeConverter;
    ...
    public List<RoomTypeVo> findByCriteria(@RequestBody RoomTypeVo roomTypeVo){
        return roomTypeConverter.toVo(roomTypeService.findByCriteria(roomTypeVo));
            ...
            @PutMapping("/archiver/")
            public RoomTypeVo archiver(@RequestBody RoomTypeVo roomTypeVo){
                RoomType roomType = roomTypeService.archiver(roomTypeConverter.toItem(roomTypeVo));
                return roomTypeConverter.toVo(roomType);
                }

            @PutMapping("/desarchiver/")
            public RoomTypeVo desarchiver(@RequestBody RoomTypeVo roomTypeVo){
                RoomType roomType = roomTypeService.desarchiver(roomTypeConverter.toItem(roomTypeVo));
                return roomTypeConverter.toVo(roomType);}
            }
