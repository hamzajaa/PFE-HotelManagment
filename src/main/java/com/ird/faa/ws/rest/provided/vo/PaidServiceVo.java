...
//    private List<RoomTypeVo> roomTypesVo;
    ...
    private List<PaidServiceItemTypeVo> paidServiceItemTypesVo;
    ...
    public List<PaidServiceItemTypeVo> getPaidServiceItemTypesVo() {
        return this.paidServiceItemTypesVo;
    }

    public void setPaidServiceItemTypesVo(List<PaidServiceItemTypeVo> paidServiceItemTypesVo) {
        this.paidServiceItemTypesVo = paidServiceItemTypesVo;
    }
