...
//    private List<PaidServiceVo> paidServicesVo;
    ...
    public List<CouponManagmentItemGuestVo> getCouponManagmentItemGuestsVo() {
        return couponManagmentItemGuestsVo;
    }

    public void setCouponManagmentItemGuestsVo(List<CouponManagmentItemGuestVo> couponManagmentItemGuestsVo) {
        this.couponManagmentItemGuestsVo = couponManagmentItemGuestsVo;
    }

    private List<CouponManagmentItemGuestVo> couponManagmentItemGuestsVo;


    public List<CouponManagmentItemRoomTypeVo> getCouponManagmentItemRoomTypesVo() {
        return couponManagmentItemRoomTypesVo;
    }

    public void setCouponManagmentItemRoomTypesVo(List<CouponManagmentItemRoomTypeVo> couponManagmentItemRoomTypesVo) {
        this.couponManagmentItemRoomTypesVo = couponManagmentItemRoomTypesVo;
    }

    private List<CouponManagmentItemRoomTypeVo> couponManagmentItemRoomTypesVo;
