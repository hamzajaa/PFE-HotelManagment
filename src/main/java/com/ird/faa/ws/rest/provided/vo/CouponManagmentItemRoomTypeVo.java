...
public class CouponManagmentItemRoomTypeVo {
    ...
    private CouponManagmentVo couponManagmentVo;


    public CouponManagmentItemRoomTypeVo() {
        super();
    }
    ...
    public CouponManagmentVo getCouponManagmentVo() {
        return this.couponManagmentVo;
    }

    public void setCouponManagmentVo(CouponManagmentVo couponManagmentVo) {
        this.couponManagmentVo = couponManagmentVo;
    }
